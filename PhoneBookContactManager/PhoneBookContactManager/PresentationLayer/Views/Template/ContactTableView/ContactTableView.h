...
//bắt đầu xoá cell
- (void)willRemoveContactFromContactTableView:(id<ContactModelProtocol>) contactModel withCallback:(contactTableCallback)callback;
- (void)didSelectContact:(id<ContactModelProtocol>)contact;
@end
